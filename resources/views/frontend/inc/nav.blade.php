                ...
                <div class="col-lg-4 text-right d-none d-lg-block">
                    <ul class="list-inline  mb-0">
                        ...
                        <li class="list-inline-item mr-0 pl-2 py-2">
                            <a href="#">
                                <div class="download_app"><i class="fa-solid fa-mobile-screen-button"></i> Download
                                    Mobile App</div>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="d-none d-lg-block position-relative  h-50px">
            <div class="container h-100">
                <div class="d-flex h-100">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="fw-700 fs-16 text-white mr-3"><i
                                            class="fa-solid fa-bars pr-1"></i>All
                                        Categories</span>
                    ...
                    <div>
                        <button class="btn track_btn">
                            <i class="fa-solid fa-mobile-screen-button"></i> Track Order
                        </button>
