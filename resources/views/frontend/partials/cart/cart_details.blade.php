...
<div class="container">
    ...
    @if ($cart_count > 0)
                                    ...
                                    <div class="aiz-checkbox-inline">
                                        <label class="aiz-checkbox d-block">
                                            ...
                                            <span class="d-flex flex-row justify-content-between align-items-center"
                                                ...
                                                <span class="fs-15 ml-3 pb-3 d-block">
                                                    {{ translate('Product') }}
                                                </span>
                                                <span class="fs-15 ml-3 pb-3 d-block"
                                                ...
                                                <span class="fs-15 ml-3 pb-3 d-block" style="margin-right: 35px;">
                                                    {{ translate('Quantity') }}
                                                </span>
                                            </span>
                                            <span class="aiz-square-check"></span>
                                ...
                                @foreach ($admin_products as $key => $product_id)
                                    ...
                                    <li class="list-group-item px-0 border-md-0">
                                        <div class="row gutters-5 align-items-center">
                                            ...
                                            <div class="col-md-2">
                                                @if ($admin_product_variation[$key] != '')
                                                <span class="text-success">{{ $admin_product_variation[$key] }}</span>
                                                @endif
                                            </div>
        ...
        <div class="d-flex flex-row justify-content-center align-items-center">
            <a href="{{ url('/') }}" class="btn btn-success fs-16 fw-600 rounded-2 px-4 text-white" style="margin-right: 10px;">Continue Shopping</a>
            <a href="{{ route('checkout') }}" class="btn btn-danger fs-16 fw-600 rounded-2 px-4 text-white">Buy Now</a>
        </div>
